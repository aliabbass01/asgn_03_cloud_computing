...
public class TwittersTwitsSentiment_Analysis extends Configured implements Tool {
	
	// Mapper Class for Twitter Twitts 
	public static class Map extends Mapper<LongWritable, Text, Text, Text>{
		private URI[] files;
		
		// Datastore
		private HashMap<String,Twitts> AFINN_map = new HashMap<String,Twitts>();
		...
		// setup and load the twits, positive, negative & stop in memory
		@Override
		public void setup(Context context) throws IOException
		{
			...
			while((line = br.readLine())!=null)
			{
				...
				Twitts twitts = new Gson().fromJson(json, Twitts.class);

				AFINN_map.put(twitts.id, twitts);
			}
			br.close();
			in.close();
		...
		// mapper 
		public void map(LongWritable key, HashMap<String,Twitts> value, Context context) throws IOException, InterruptedException{
	...
	public static class Reduce extends Reducer<Text,Text,Text,Text>{
		public void reduce(Text key, HashMap<String,Twitts> value, Context context) throws IOException, InterruptedException{
			//
			// A tweet i will be positive if s i is greater than 0
			try{
	...
	public static void main(String[] args) throws Exception{
		ToolRunner.run(new TwittersTwitsSentiment_Analysis(),args);
	}
	...
	// TODO Auto-generated method stub
		...
		job.setJarByClass(TwittersTwitsSentiment_Analysis .class);
